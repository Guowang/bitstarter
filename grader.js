...
var URL_DEFAULT = "http://shrouded-forest-4110.herokuapp.com"
...
if(require.main == module) {
	...
	.parse(process.argv);
    if (program.url) {
	rest.get(program.url).on('complete', function(fetched_html) {
	  fs.writeFileSync(program.file, fetched_html);
	});
    }
